...
let listsCollapsed = localStorage.getItem("lists-collapsed") ? JSON.parse(localStorage.getItem("lists-collapsed")) : {};
...
function setCollapsedElements() {
	...
	let closedLists = Object.entries(listsCollapsed).filter(v => v[1]).map(v => v[0]);
