...
function updateScrollDebounce() {
  ...
  scrollDebounce = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _getPageProgress, _getPageProgress2, currentPage, pageCount, pathname, res, unreadCount;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _getPageProgress = getPageProgress(), _getPageProgress2 = _slicedToArray(_getPageProgress, 2), currentPage = _getPageProgress2[0], pageCount = _getPageProgress2[1];
